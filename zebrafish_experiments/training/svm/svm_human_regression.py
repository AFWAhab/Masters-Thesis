...
tokenized_sequences_test = tokenize_genes_substring("../../paperData/pM10Kb_1KTest/human_promoter_sequences_test.fasta", 3000, 13501, 6)
tokenized_sequences_val = tokenize_genes_substring("../../paperData/pM10Kb_1KTest/human_promoter_sequences_valid.fasta", 3000, 13501, 6)
tokenized_sequences_training = tokenize_genes_substring("../../paperData/pM10Kb_1KTest/human_promoter_sequences_train.fasta", 3000, 13501, 6)
