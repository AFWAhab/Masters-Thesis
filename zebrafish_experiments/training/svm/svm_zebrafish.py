...
tokenized_sequences_test = tokenize_genes_substring("../zebrafish_promoter_sequences_test.fasta", 8500, 11501, 6)
tokenized_sequences_val = tokenize_genes_substring("../zebrafish_promoter_sequences_validation.fasta", 8500, 11501, 6)
tokenized_sequences_training = tokenize_genes_substring("../zebrafish_promoter_sequences_training.fasta", 8500, 11501, 6)
