...
OUTPUT_PATH = "../data/pig/fasta_output/10k-corrected/"
LAST_GENE_ID = None
...
def save_fasta_file(gene_id, chromosome, tss, reverse):
    ...
    with open(OUTPUT_PATH + "combined.fa", 'a') as file:
        file.write("> " + gene_id + " - Reversed: " + str(reverse) + "\n")
        base_string = convert_bases_to_string(bases, reverse)
