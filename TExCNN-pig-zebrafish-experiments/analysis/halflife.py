...
from gtf2df import gtf2df

#genome_dir = "..\\data\\zebrafishGenome"
genome_dir = "../data/pig/bgee/data/GENOME/" # PIG GENOME HERE
...
def process_gtf(gtf_file, output_csv, ids):
    ...
    with open(output_csv, "w", newline="") as csvfile:
        ...
        for idx, row in ids.iterrows():
            ...
            chr_file = os.path.join(genome_dir,
                                    f"Sus_scrofa.Sscrofa11.1.dna.primary_assembly.{row.loc['Chromosome']}.fa")
            ...
            with open(chr_file, "rt") as handle:
...
if __name__ == '__main__':
    ...
    gene_ids = pd.read_csv("../data/pig/pig_tss_CORRECTED.csv", sep=",")
    process_gtf("../data/Sus_scrofa.Sscrofa11.1.114.gtf", "pig_halflife_data.csv", gene_ids)